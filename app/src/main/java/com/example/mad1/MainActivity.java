...
public class MainActivity extends AppCompatActivity implements VideoRVAdaptor.VideoClickInterface {
    ...
    private void displayBottomSheet(VideoRVModal videoRVModal){
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(MainActivity.this, EditVideoActivity.class);
