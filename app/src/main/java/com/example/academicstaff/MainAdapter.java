package com.example.academicstaff;
...
public class MainAdapter extends FirebaseRecyclerAdapter<MainModel,MainAdapter.myViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull myViewHolder holder,  final int position, @NonNull MainModel model) {
        this.holder = holder;
                        ...
                        FirebaseDatabase.getInstance().getReference().child("teachers")
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(holder.name.getContext(), "Data Updating Successfully", Toast.LENGTH_SHORT).show();
                                        dialogPlus.dismiss();
                                    }
                                })
